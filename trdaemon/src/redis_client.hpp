...
#define MODULE_NAMESPACE		"trd"
#define MODULE_TYPE				ModuleType::Table
...
public:
	...
	void report_recognized(std::string const & json)
	{
		send_message(RedisCommand::Recognized, json);
	}
